...
def credit_note_inv(company_id = None):
    ...
    redirect_record = frappe.get_value(
        'Tally Different Function',
        {
            ...
            'tally_function_name': 'credit_note_inv'
        },
        'redirection_path'
    )
    ...
    if redirect_record:
        ...
        enable_sync = frappe.get_value('Voucher Sync Control', {'voucher_name': 'Credit Note (Inventory)'}, ['enable_sync'])
        if not enable_sync:
            final_voucher = {
                "status": True,
                "VOUCHERDETAILS": {
        ...
        for doc in credit_list:
            ...
            for ledger in gl_entry:
                ...
                account_type = frappe.get_value('Account', ledger['account'], 'account_type')

                if account_type == 'Income Account':
                    ledgername = ledger['account']

                    tally_parent = frappe.get_value('Account', ledgername, 'custom_tally_parent_account')
                    ...
                    for item in sales_item:
                        ...
                        ledger_dict = {
                            ...
                            "LedgerAddress": cus_address[0]['city'] if cus_address and tally_parent== "Sundry Debtors" else "", 
                            "LedgerState": cus_address[0]['state'] if cus_address and tally_parent== "Sundry Debtors" else "", 
                            "LedgerCountry": cus_address[0]['country'] if cus_address and tally_parent== "Sundry Debtors" else "", 
                            "LedgerPincode": cus_address[0]['pincode'] if cus_address and tally_parent== "Sundry Debtors" else "", 
                            "LedgerMobile": cus_address[0]['phone'] if cus_address and tally_parent== "Sundry Debtors" else "", 
                            "LedgerGstReg": gst_category if tally_parent == "Sundry Debtors" else "", 
                            "LedgerPan": customer_pan if tally_parent == "Sundry Debtors" else "", 
                            "LedgerGstin": cust_gstin.gstin if tally_parent == "Sundry Debtors" else "",
                            ...
                            "BuyerName": doc.customer if tally_parent== "Sundry Debtors" else "",
                            "BuyerMailingName": doc.customer if tally_parent== "Sundry Debtors" else "",
                            "BuyerAddress1": cus_address[0]['address_line1'] if tally_parent== "Sundry Debtors" and cus_address else "",
                            "BuyerAddress2": cus_address[0]['address_line2'] if tally_parent== "Sundry Debtors" and cus_address else "",
                            "BuyerState": cus_address[0]['state'] if tally_parent== "Sundry Debtors" and cus_address else "",
                            "BuyerCountry": cus_address[0]['country'] if tally_parent== "Sundry Debtors" and cus_address else "",
                            "BuyerGstReg": gst_category if tally_parent== "Sundry Debtors" else "",
                            "BuyerGSTIN": cust_gstin.gstin if tally_parent== "Sundry Debtors" else "",
                            "BuyerPincode": cus_address[0]['pincode'] if tally_parent== "Sundry Debtors" and cus_address else "",

                            "ConsigneeName": cus_ship_address[0]['address_title'] if tally_parent== "Sundry Debtors" and cus_ship_address else "",
                            "ConsigneeMailingName": cus_ship_address[0]['address_title'] if tally_parent== "Sundry Debtors" and cus_ship_address else "",
                            "ConsigneeAddress1": cus_ship_address[0]['address_line1'] if tally_parent== "Sundry Debtors" and cus_ship_address else "",
                            "ConsigneeAddress2": cus_ship_address[0]['address_line2'] if tally_parent== "Sundry Debtors" and cus_ship_address else "",
                            "ConsigneeState": cus_ship_address[0]['state'] if tally_parent== "Sundry Debtors" and cus_ship_address else "",
                            "ConsigneeCountry": cus_ship_address[0]['country'] if tally_parent== "Sundry Debtors" and cus_ship_address else "",
                            "ConsigneeGSTIN": cust_gstin.gstin if tally_parent== "Sundry Debtors" else "",
                            "ConsigneePincode": cus_ship_address[0]['pincode'] if tally_parent== "Sundry Debtors" and cus_ship_address else "",
                            "PlaceOfSupply" : doc.place_of_supply.split("-", 1)[1] if tally_parent== "Sundry Debtors" and doc.get('place_of_supply') and "-" in doc.place_of_supply else '',
